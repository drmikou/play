...
CKEDITOR.dialog.add("base64imageDialog", function(editor){
	...
	function imagePreviewLoad(s) {
		...
		i.onload = function() {
			...
			if(orgWidth == null || orgHeight == null) {
				...
				//if(orgWidth>640) { t.setValueOf("tab-properties", "width", 640); imageDimensions("width"); }
			} else {
				orgWidth = null;
				orgHeight = null;
			}
	...
	function imageDimensions(src) {
		...
		if(o.w > 640) {o.w = 640; imageDimensions("width"); }
    ...
    return {
		...
		onLoad: function(){
			...
			/*if (parseInt(this.getContentElement("tab-properties", "width").getInputElement().value,10) > 640) {
				this.getContentElement("tab-properties", "width").getInputElement().value = 640;
			...
			this.getContentElement("tab-properties", "width").getInputElement().on("change", function(){ if(this.$.value > 640) { this.$.value = 640; imageDimensions("width"); } });
