 ...
 *
 * == END LICENSE ==
 * ========================== WARNING READ BEFORE UPDATE =======================
 * @Update : adapted to our editor
 * @see line 81
 *
 */
		...
		editor.ui.addRichCombo( 'Zoom',
			{
				...
				init : function()
				{
					var zoomOptions = [25, 50, 75, 100, 125, 150],
						zoom;
				...
				{
					/**
					 * IMPORTANT : Personal modification must be preserved on updates
					 */
					var body = document.getElementById("page_container");
					/**
					 * END
					 */
